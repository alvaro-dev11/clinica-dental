...
<div class="card-header">
    <a href="{{ route('admin.roles.create') }}" class="btn btn-secondary">Crear nuevo rol</a>
</div>
                ...
                <tr>
                    ...
                    <td width="10px" class="text-center">
                        @can('admin.roles.edit')
                            <a href="{{ route('admin.roles.edit', $rol) }}" class="btn btn-warning btn-sm"><i
